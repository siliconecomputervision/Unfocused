...
#xl_base_filename = os.path.join(modelfile_path, f'{Base_Model}')
#xl_refiner_filename = os.path.join(modelfile_path, f'{Refiner_Model}')
#xl_base_offset_lora_filename = os.path.join(lorafile_path, f'{Lora_Model}')
