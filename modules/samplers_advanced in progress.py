...
#                "seed": ("INT", {"default": 0, "min": 0, "max": 0xffffffffffffffff}),
                "total steps": ("INT", {"default": 60, "min": 1, "max": 10000}),
#                "switch steps": ("INT", {"default": 40, "min": 1, "max": 10000}),
...
#                "latent_image": ("LATENT", ),
    ...
    def __init__(self, model, refiner_model, steps, device, sampler, scheduler, denoise=None, model_options={}):
